...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        movie1 = Movie.objects.get(title="The Arrival of a Train")
        movie2 = Movie.objects.get(title="The House of the Devil")
        ...
        # ✅ Show the generated embeddings
        self.stdout.write(f"Embedding '{movie1.title}': dim={emb1.shape[0]} -> {emb1[:4]} ...")
        self.stdout.write(f"Embedding '{movie2.title}': dim={emb2.shape[0]} -> {emb2[:4]} ...")
